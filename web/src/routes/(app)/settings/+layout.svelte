...
<div class="w-full p-6 space-y-6">
	...
	<div class="grid w-full items-start gap-12 md:grid-cols-[180px_1fr] lg:grid-cols-[250px_1fr]">
			...
			{#each navigation as { title, href, icon, danger }}
				...
				<a
					...
					class={cn(
						...
						danger
							? 'flex items-center gap-3 rounded-lg px-3 py-2 text-destructive transition-all hover:text-destructive/80 hover:text-primary'
